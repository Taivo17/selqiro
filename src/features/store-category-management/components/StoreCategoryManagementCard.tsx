  ...
  return (
    <section className="rounded-[30px] border border-black/5 bg-white p-6 shadow-sm">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        {!loading && !error ? (
          <span className="w-fit rounded-full bg-neutral-100 px-3 py-2 text-xs font-black text-neutral-600">
          ...
          {roots.map((rootCategory) => {
            ...
            return (
              ...
              >
                ...
                {children.length > 0 ? (
                  <div className="mt-4 space-y-2 border-l-2 border-neutral-200 pl-3">
                    {children.map((childCategory) => (
                      <div
                        key={childCategory.id}
                        className="rounded-2xl border border-neutral-200 bg-white px-3 py-2.5"
                      >
